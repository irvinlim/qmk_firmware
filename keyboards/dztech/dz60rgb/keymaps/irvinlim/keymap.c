...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [DEFAULT_LAYER] = LAYOUT(
        ...
        // R4
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_UP, LT(MAC_FN_LAYER, KC_GRV),
        // R5
        KC_LCTL, KC_LALT, KC_LCMD, KC_SPC, KC_RCMD, MO(FN_LAYER), KC_LEFT, KC_DOWN, KC_RIGHT),
    ...
    [FN_LAYER] = LAYOUT(
        ...
        // R4
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_RSFT, KC_PGUP, MO(SYSTEM_LAYER),
        // R5
